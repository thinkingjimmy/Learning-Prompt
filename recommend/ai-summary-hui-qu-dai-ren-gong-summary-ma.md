...
:::info 本篇博文首发于我的付费专栏[播客小捕手](https://xiaobot.net/p/xiaobushous1?refer=599951e8-47eb-4898-aa3b-a7d0a1a06b0f) ，可以点击查看该专栏，了解下这个专栏是干啥的，这样你更能体会到这篇博文的背景。 :::
...
还是以 Knowledge Project 141 为例，Summarize.tech 的 [Summary](../docs/insight/v/) 方式是将视频切分成 5 分钟的一段，然后再对生成的内容进行二次总结。我们一起看看这个结果：
